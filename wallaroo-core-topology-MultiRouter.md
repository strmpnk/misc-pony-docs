...
```pony
new val create(
  routers: Array[Router val] val)
: MultiRouter val^
```
#### Parameters

*   routers: [Array](builtin-Array)\[[Router](wallaroo-core-topology-Router) val\] val

#### Returns

* [MultiRouter](wallaroo-core-topology-MultiRouter) val^
