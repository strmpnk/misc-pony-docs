...
new iso create(
  ...
  connection_count: U32 val)
: ConnectingNotify iso^
```
#### Parameters
...
*   connection_count: [U32](builtin-U32) val

#### Returns

* [ConnectingNotify](wallaroo-ent-spike-ConnectingNotify) iso^
